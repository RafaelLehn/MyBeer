...
final class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        loginButton.backgroundColor = #colorLiteral(red: 0.9607843161, green: 0.7058823705, blue: 0.200000003, alpha: 1)
        ...
        NSLayoutConstraint.activate([
            ...
            loginButton.topAnchor.constraint(equalTo: mainStackView.bottomAnchor, constant: 60),
...
extension LoginViewController: LoginViewModelDelegate {
    func reject() {
        let myAlertController: UIAlertController = UIAlertController(title: "Hey.. Yoy are drunk?", message: "The login and password field must be filled in!", preferredStyle: .alert)
